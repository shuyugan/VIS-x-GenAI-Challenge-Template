...
class VisualizerPrompt:
 ...
 .          - `chart_type` should be a standard, executable visualization type (e.g., "bar", "line", "scatter", "histogram", "boxplot", "heatmap").
    ...
    CODE_GENERATOR = """
        ...
        5. **Please always remember to import necessary libraries at the beginning of your code!!!(e.g., do not forger to import seaborn as sns, matplotlib.pyplot as plt, pandas as pd, networkx as nx, etc.)**. Otherwise it will result in ERROR!
